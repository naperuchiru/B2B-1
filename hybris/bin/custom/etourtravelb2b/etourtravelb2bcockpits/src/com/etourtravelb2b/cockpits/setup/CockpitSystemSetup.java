 ...
 *  
 */
package com.etourtravelb2b.cockpits.setup;
...
import com.etourtravelb2b.cockpits.constants.Etourtravelb2bCockpitsConstants;
 ...
 */
@SystemSetup(extension = Etourtravelb2bCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(Etourtravelb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(Etourtravelb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						Etourtravelb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/etourtravelb2bcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
