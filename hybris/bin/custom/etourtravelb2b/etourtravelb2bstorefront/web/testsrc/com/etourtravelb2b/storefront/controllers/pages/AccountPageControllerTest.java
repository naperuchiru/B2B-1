...
public class AccountPageControllerTest
{
	...
	@Mock
	private Etourtravelb2bUpdateProfileForm etourtravelb2bUpdateProfileForm;
	@Mock
	...
	public void shouldNotUpdateProfile() throws CMSItemNotFoundException, DuplicateUidException
	{
		...
		final String profilePage = accountController.updateProfile(etourtravelb2bUpdateProfileForm, bindingResult, page,
				redirectModel);
