$(document).ready(function(){
	...
	//new Imager('a[href="/etourtravelb2bstorefront/electronics/de/Open-Catalogue/Cameras/Camera-Accessories-%26-Supplies/Camera-Lenses/c/588"] .js-responsive-image');
