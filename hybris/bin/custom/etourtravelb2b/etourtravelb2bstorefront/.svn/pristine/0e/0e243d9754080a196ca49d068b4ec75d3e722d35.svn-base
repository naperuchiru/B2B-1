 ...
 *
 */
package com.etourtravelb2b.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('etourtravelb2bstorefront.generic.cms.component.controller.authorized.group')}")
