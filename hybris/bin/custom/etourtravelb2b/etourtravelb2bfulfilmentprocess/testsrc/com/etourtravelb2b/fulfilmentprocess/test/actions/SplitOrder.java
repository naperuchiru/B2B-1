 ...
 *  
 */
package com.etourtravelb2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(Etourtravelb2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Etourtravelb2bFulfilmentProcessConstants.PARENT_PROCESS);
