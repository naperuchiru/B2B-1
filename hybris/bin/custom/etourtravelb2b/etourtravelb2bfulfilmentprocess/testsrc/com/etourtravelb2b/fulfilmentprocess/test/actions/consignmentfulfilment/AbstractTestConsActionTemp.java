 ...
 *  
 */
package com.etourtravelb2b.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, Etourtravelb2bFulfilmentProcessConstants.PARENT_PROCESS);
