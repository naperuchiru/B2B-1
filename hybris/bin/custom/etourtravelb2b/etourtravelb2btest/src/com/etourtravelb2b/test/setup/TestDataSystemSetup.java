 ...
 *  
 */
package com.etourtravelb2b.test.setup;
...
import com.etourtravelb2b.test.constants.Etourtravelb2bTestConstants;
import com.etourtravelb2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Etourtravelb2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/etourtravelb2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/etourtravelb2btest/import/reviews.impex");
			...
			importImpexFile(context, "/etourtravelb2btest/import/cstickets.impex");
		}
	}
}
